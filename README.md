...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <section class="section-1" style="height: 870px">
        <div>
          <h2 class="header-name">TRADITIONAL ARTISAX BAKERY</h2>
          <p class="header-text">
          ...
          <div class="btn-cont">
            <a href="" class="header-btn">SHOP NOW</a>
          </div>
        </div>
        <div class="products-cards">
          <div class="product-inf">
            <div class="product-card">
              <img
                style="padding-top: 20px; width: 190px; height: 130px"
                src="src/images/cookies.webp"
                alt="aaa"
              />

              <div class="card-text">
                <p class="price-product">$8.00(kg)</p>
                <p class="product-name">American Cockie</p>
                <a style="margin-top: 20px" href="" class="product-btn">BUY</a>
              </div>
            </div>
          </div>
          ...
          <div class="product-card">
            <img
              style="width: 213px; height: 225px"
              src="src/images/croissant.webp"
              alt="aaa"
            />
            <div class="card-text">
              <p style="padding-left: 20px" class="price-product">$4.00</p>
              <p style="padding-left: 10px" class="product-name">
                Crushed with chockolate
              </p>
          ...
          <div class="product-card">
            <img
              style="width: 193px; margin-top: 15px; height: 193px"
              src="src/images/buiscuit.webp"
              alt="aaa"
            />
            <div class="card-text">
              <p style="padding-left: 10px" class="price-product">
                For piece $4.00
              </p>
              <p
                style="padding-left: 8px; margin-bottom: 19px"
                class="product-name"
              >
                Blackberry pie
              </p>
              <a href="" style="margin-bottom: 20px" class="product-btn">BUY</a>
            </div>
          </div>
        </div>
      </section>
      <section class="menu">
        <div><h2 class="main-menu">MENU</h2></div>
        <div class="menu-cards">
          <div class="menu-card">
            <div class="menu-card1">
              <img
                src="src/images/breadmenu.webp"
                style="width: 294px; height: 184px; padding-top: 30px"
                alt="aaa"
              />
              <p style="padding-top: 20px" class="name-product">Breads</p>
            </div>
          ...
          <div class="menu-card">
            <div class="menu-card1">
              <img
                style="width: 347px; height: 230px"
                src="src/images/bakery.webp"
                alt="aaa"
              />
              <p class="name-product" style="padding-top: 5px">Bekary</p>
            </div>
            <a href="" class="menu-btn">Order</a>
          </div>
          <div class="menu-card">
            <div class="menu-card1">
              <img
                src="src/images/cakescapcakes.webp"
                style="width: 231.566px; height: 230px"
                alt="aaa"
              />
              <p class="name-product">Cakes & Capcakes</p>
            </div>
            <a href="" class="menu-btn">Order</a>
          </div>
          <div class="menu-card">
            <div class="menu-card1">
              <img
                src="src/images/coockiespretzels.webp"
                style="width: 226px; height: 230px"
                alt="aaa"
              />
              <p class="name-product">Coockies&Pretzels</p>
            </div>
            <a href="" class="menu-btn">Order</a>
          </div>
        </div>
      ...
      <section class="quality">
        <div class="quality">
          <div>
            <h2 class="quality-text">Quality our bekary</h2>
          </div>
          <div class="quality-cards">
            <div class="quality-card">
              <img src="src/images/breadmenu.webp" alt="aaa" />
              <div class="quality-sticker">
                <p>1.Flour with fresh wheat</p>
                <p>2.New drozzhi</p>
                <p>3.Fresh eggs</p>
                <p>4.Water from the well</p>
              </div>
            </div>

            <div style="margin-top: 100px" class="quality-card">
              <img src="src/images/coockie.webp" alt="aaa" />
              <div class="quality-sticker">
                <p>1.Flour with fresh wheat</p>
                <p>2.New drozzhi</p>
                <p>3.Fresh eggs</p>
            ...
            <div style="margin-top: 200px" class="quality-card">
              <img src="src/images/cake.webp" alt="aaa" />
              <div class="quality-sticker">
                <p style="line-height: 30px">
                  1.Flour with fresh wheat the well
                </p>
                <p>2.New drozzhi</p>
                <p>3.Fresh eggs</p>
                <p>4.Water from</p>
      ...
      <section class="traditional">
        <h2 class="traditional-text">Why TRADITIONALARTISAX BAKERY ?</h2>
        <div class="traditional-cards">
          <div class="tradiitional-card">
            <svg
          ...
          <div class="tradiitional-card">
            ...
            <p class="shos">Speed Delivery 24 h</p>
          </div>
        </div>
      </section>
    </main>
      ...
      <div class="footer">
        <div class="inf-cont">
          <div class="where">
            ...
            <img src="src/images/map.webp" alt="aaa" />
          </div>
        ...
        <div class="footer-cont">
          <div
            style="padding-left: 200px; padding-top: 100px"
          ...
          <div style="display: flex; gap: 100px; padding-top: 100px">
            <div class="about">
              <p style="padding-bottom: 40px" class="about-p">About</p>
              <div>
                <p class="about-p">About us</p>
                <p class="about-p">Features</p>
                <p class="about-p">News & Blog</p>
              </div>
            </div>
            <div class="movement">
              <p style="padding-bottom: 40px" class="movement-p">Movement</p>
              <div>
                <p class="movement-p">What Eatly</p>
                <p class="movement-p">Support Us</p>
              </div>
            </div>
            <div class="company">
              <p class="company-p" style="padding-bottom: 40px">Company</p>
              <div>
                <p class="company-p">Why Eatly</p>
                <p class="company-p">Capital</p>
                <p class="company-p">Securaty</p>
              </div>
            </div>
          </div>
        </div>
